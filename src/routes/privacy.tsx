...
export const Route = createFileRoute("/privacy")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Политика обработки персональных данных Тойота Центр Павлодар.",
      },
    ],
  }),
  ...
  return (
    <LegalPageLayout title="Политика конфиденциальности">
      <p>
        ...
        {LEGAL_SITE.legalEntity}), {LEGAL_SITE.address}, {LEGAL_SITE.city}, обрабатывает
        персональные данные пользователей, оставивших заявку через рекламу в Facebook и Instagram
        (Meta Lead Ads), а также через формы на связанных landing-страницах и CRM-системе дилера.
      </p>
      ...
      <LegalSection title="2. Какие данные мы собираем">
        ...
        <ul className="list-disc space-y-1 pl-5">
          ...
          <li>
            технические идентификаторы рекламы (ID кампании, объявления, формы) — для аналитики.
          </li>
        </ul>
      </LegalSection>
      ...
      <LegalSection title="4. Правовые основания">
        <p>
          Обработка осуществляется на основании согласия пользователя при отправке лид-формы, а
          также для исполнения запроса пользователя и законных интересов дилера в обработке
          обращений клиентов в соответствии с законодательством Республики Казахстан о персональных
          данных.
        </p>
      </LegalSection>
      ...
      <LegalSection title="5. Хранение и доступ">
        <p>
          ...
          шифрованием и контролем доступа). Доступ имеют только уполномоченные сотрудники
          кол-центра, отдела продаж, сервиса и маркетинга {LEGAL_SITE.companyName} — в объёме,
          необходимом для выполнения служебных обязанностей.
        </p>
      </LegalSection>
      ...
      <LegalSection title="6. Срок хранения">
        <p>
          ...
          момента последнего контакта, если иное не требуется для бухгалтерского или договорного
          учёта).
        </p>
      </LegalSection>
